<?php
// api.php - Sistema ENEDES configurado EXCLUSIVAMENTE para Render PostgreSQL
...
// ✅ CONFIGURAÇÃO RENDER POSTGRESQL - Credenciais corretas da sua imagem
function getDbConnection() {
    // Tentar environment variable primeiro (melhor prática)
    $database_url = getenv('DATABASE_URL');
    
    if ($database_url) {
        // Parse da DATABASE_URL do Render
    ...
    try {
        ...
        // Garantir autocommit para evitar problemas de transação
...
function createTablesIfNeeded($pdo) {
    try {
        // TABELA METAS - estrutura híbrida para compatibilidade
        ...
        // TABELA ACTIONS - estrutura exata do frontend
    ...
    switch ($endpoint) {
        ...
        case 'test':
            if ($method === 'GET') {
                ...
                echo json_encode([
                    ...
                    'config_method' => getenv('DATABASE_URL') ? 'Environment Variable (Render)' : 'Direct Credentials',
        ...
        default:
            echo json_encode([
                ...
                'version' => '3.2 - Render PostgreSQL Final',
                'database_provider' => 'Render PostgreSQL',
                'database' => [
                    'provider' => 'Render PostgreSQL',
                    'hostname' => 'dpg-d1u47ber433s73ebqecg-a',
                ...
                'endpoints_funcionais' => [
                    ...
                    'POST ?endpoint=goals' => 'Criar nova meta',
                    'PUT ?endpoint=goals' => 'Atualizar meta',
                    'DELETE ?endpoint=goals' => 'Excluir meta',
                    'GET ?endpoint=actions' => 'Listar todas as ações',
                    'POST ?endpoint=actions' => 'Criar nova ação',
                    'PUT ?endpoint=actions' => 'Atualizar ação',
                    'DELETE ?endpoint=actions' => 'Excluir ação',
